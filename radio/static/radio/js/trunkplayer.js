          ...
          for (unit in data.results[a].units) {
              ...
              if(data.results[a].units[unit].description) {
                  if(js_config.radio_change_unit) {
			          ...
			          new_html += '<a href="/unit/' + data.results[a].units[unit].slug + '/">' + data.results[a].units[unit].description + '</a>';
                      //new_html += '<a href="/admin/radio/unit/' + data.results[a].units[unit].pk + '/">#</a>, ';
					  new_html += '<a href="/unitupdate/' + data.results[a].units[unit].pk + '/" data-toggle="modal" data-target="#unitupdatemodal">#</a>, ';
                  } else {
